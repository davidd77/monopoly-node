...
var nueva = new Cas({num:0, Nombre:"Salida", precio:200, url:"/img/casillas/salida.jpg"});
...
nueva.save(function(err){ console.log(err); });
var nueva = new Cas({num:2, Nombre:"Caja de Comunidad", precio:0, url:"/img/casillas/caja.png"});
nueva.save(function(err){ console.log(err); });
var nueva = new Cas({num:3, Nombre:"Plaza Lavapiés", precio:60, url:"/img/casillas/Plaza-lavapies.jpg"});
nueva.save(function(err){ console.log(err); });
var nueva = new Cas({num:4, Nombre:"Impuesto sobre capital", precio:200, url:"/img/casillas/impuestosociedad.png"});
nueva.save(function(err){ console.log(err); });
...
nueva.save(function(err){ console.log(err); });
var nueva = new Cas({num:7, Nombre:"Suerte", precio:0, url:"/img/casillas/suerte.png"});
nueva.save(function(err){ console.log(err); });
...
nueva.save(function(err){ console.log(err); });
var nueva = new Cas({num:10, Nombre:"Carcel", precio:0, url:"/img/casillas/carcel2.jpg"});
nueva.save(function(err){ console.log(err); });
...
nueva.save(function(err){ console.log(err); });
var nueva = new Cas({num:17, Nombre:"Caja de Comunidad", precio:0, url:"/img/casillas/caja.png"});
nueva.save(function(err){ console.log(err); });
...
nueva.save(function(err){ console.log(err); });
var nueva = new Cas({num:22, Nombre:"Suerte", precio:0, url:"/img/casillas/suerte.png"});
nueva.save(function(err){ console.log(err); });
...
nueva.save(function(err){ console.log(err); });
var nueva = new Cas({num:30, Nombre:"Ve a la cárcel", precio:0, url:"/img/casillas/carcel.jpg"});
nueva.save(function(err){ console.log(err); });
...
nueva.save(function(err){ console.log(err); });
var nueva = new Cas({num:33, Nombre:"Caja de Comunidad", precio:0, url:"/img/casillas/caja.png"});
nueva.save(function(err){ console.log(err); });
...
nueva.save(function(err){ console.log(err); });
var nueva = new Cas({num:36, Nombre:"Suerte", precio:0, url:"/img/casillas/suerte.png"});
nueva.save(function(err){ console.log(err); });
var nueva = new Cas({num:37, Nombre:"Paseo de la Castellana", precio:350, url:"/img/casillas/paseo_de_la_castellana.png"});
nueva.save(function(err){ console.log(err); });
var nueva = new Cas({num:38, Nombre:"Impuesto de lujo", precio:100, url:"/img/casillas/impuestolujo.png"});
nueva.save(function(err){ console.log(err); });
